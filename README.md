...
<mapper namespace="com.ming.blog.template.modules.ums.mapper.UmsMenuMapper">

    <select id="getMenuList" resultType="com.ming.blog.template.modules.ums.model.UmsMenu">
        SELECT
        m.id id,
